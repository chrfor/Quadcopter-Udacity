...
class Actor:
    ...
    def build_model(self):
        ...
        # Add hidden layers  # Following recommendations CONTINUOUS CONTROL WITH DEEP REINFORCEMENT LEARNING #  Updated
        ...
        # Add final output layer with tanh activation  #  Updated
