...
class PhysicsSim():
    ...
    def reset(self):
        self.time = 0.0
        self.pose = np.array([0.0, 0.0, 0.5, 0.0, 0.0, 0.0]) if self.init_pose is None else np.copy(self.init_pose) 
        #replacing 10 in 3rd position by 0.5 as starting possition
